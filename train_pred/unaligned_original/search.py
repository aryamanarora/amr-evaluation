...
preds_aligned = open('train_pred_aligned.txt').read().strip().split('\n\n')
        ...
        for i in range(len(preds)):
            ...
            if found or found2:
                ...
                fout.write(f'<tr><td id="data" valign="top" style="background-color:{green if found else red}"><pre style="margin:0;padding:0;width:400px;overflow:auto;">({golds[i][1]}</pre></td> \
                    <td id="data" valign="top" style="background-color:{green if found2 else red}"><pre style="margin:0;padding:0;width:400px;overflow:auto;">({preds[i][1]}</pre></td> \
                    <td id="data" valign="top" style="background-color:{green if found3 else red}"><pre style="margin:0;padding:0;width:400px;overflow:auto;">({preds_aligned[i][1]}</pre></td></tr>\n')
        ...
        for i in range(len(preds)):
            ...
            if found:
                ...
                fout.write(f'<tr><td id="data" valign="top"><pre style="margin:0;padding:0;width:400px;overflow:auto;">({golds[i][1]}</pre></td> \
                    <td id="data" valign="top"><pre style="margin:0;padding:0;width:400px;overflow:auto;">({preds[i][1]}</pre></td> \
                    <td id="data" valign="top"><pre style="margin:0;padding:0;width:400px;overflow:auto;">({preds_aligned[i][1]}</pre></td></tr>\n')
        fout.write('</table></body>')
